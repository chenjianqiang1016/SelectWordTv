...
public class MyTriangleUpView extends View {
    ...
    public MyTriangleUpView(Context context) {
        this(context, null);
    }

    public MyTriangleUpView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyTriangleUpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void calculateCoordinate() {
        ...
        point_1_x = 0;
        point_1_y = view_height - value;

        point_2_x = view_width / 2f;
        point_2_y = 0;

        point_3_x = view_width;
        point_3_y = view_height - value;
        ...
        trianglePath.lineTo(view_width, view_height);
        trianglePath.lineTo(0, view_height);
        trianglePath.close();
